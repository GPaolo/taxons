...
class AutoEncoder(nn.Module):
  ...
  def __init__(self):
    ...
    self.encoder = nn.Sequential(
      nn.Conv3d(in_channels=3, out_channels=8, kernel_size=7, stride=(1, 2, 2), dilation=(1, 1, 1)), nn.LeakyReLU(),
      # 75 -> 35
      nn.Conv3d(in_channels=8, out_channels=4, kernel_size=5, stride=(1, 3, 3), dilation=(1, 1, 1)), nn.LeakyReLU()).to(
      self.device)  # 35 -> 11
    self.decoder = nn.Sequential(
      nn.ConvTranspose3d(in_channels=4, out_channels=4, kernel_size=5, stride=(1, 3, 3), dilation=(1, 1, 1)),
      nn.LeakyReLU(),
      nn.ConvTranspose3d(in_channels=4, out_channels=3, kernel_size=7, stride=(1, 2, 2), dilation=(1, 1, 1)),
